...
def train(grad, epochs, learning_rate, params, X_train, Y_train, performance=True):
    '''
    ...
    for i in range(epochs):
        ...
        if(performance):
            ...
            print("Accuracy:"+str(accuracy(params, X_train, Y_train)))
            print('\n')
    return params
...
def word2vec_model(corpus_file_path, dims, window_size, epochs, learning_rate, performance=True):
    '''
    ...
    optimized_params = train(gradloss, epochs, learning_rate, init_params, X_train,
                             Y_train,performance=performance)
